...
public class YihuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		YihuEntity user = yihuService.selectOne(new EntityWrapper<YihuEntity>().eq("gonghao", username));
    ...
    public R register(@RequestBody YihuEntity yihu){
    	...
    	YihuEntity user = yihuService.selectOne(new EntityWrapper<YihuEntity>().eq("gonghao", yihu.getGonghao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YihuEntity yihu,
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YihuEntity yihu, 
		HttpServletRequest request){
        EntityWrapper<YihuEntity> ew = new EntityWrapper<YihuEntity>();
		PageUtils page = yihuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yihu), params), params));
        return R.ok().put("data", page);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YihuEntity> wrapper = new EntityWrapper<YihuEntity>();
		if(map.get("remindstart")!=null) {
